...
def pipeline_with_logprob(
    ...
    fix_window: Optional[tuple[int, int]]=None,
):
    ...
    if fix_window is not None:
        sde_window = fix_window
    elif sde_window_size > 0:
    ...
    latents = self._unpatchify_latents(latents).to(dtype=self.vae.dtype)
